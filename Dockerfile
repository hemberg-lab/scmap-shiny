...
RUN apt-get update && apt-get install software-properties-common python-software-properties && add-apt-repository ppa:edd/misc && apt-get update && apt-get install r-cran-git2r
